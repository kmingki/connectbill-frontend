...
const ReviewDetailPage = () => {
    ...
    return (
        ...
        <div>
            <img alt="클라이언트 프로필이미지" src={`http://localhost:8000${reviewDetail?.review.client_profile_image}`}></img>
        ...
        <h2>Before</h2>
        {
            ...
            <PanoramaWrapper>
                ...
                <a-sky src={`http://localhost:8000${reviewDetail?.review?.commission_image}`}
                rotation="0 -130 0" >
                </a-sky>
                </a-scene>
            </PanoramaWrapper>
        ...
        <h2>After</h2>
        {
            ...
            <PanoramaWrapper>
                <a-scene class="aframebox" embedded>
                <a-sky src={`http://localhost:8000${reviewDetail?.review?.panorama_image}`}
                rotation="0 -130 0" >
                </a-sky>
                </a-scene>
            </PanoramaWrapper>
        ...
        <div>
            ...
            <Avatar alt="클라이언트 프로필이미지" src={`http://localhost:8000${reviewDetail?.designer_review.designer_profile_image}`}></Avatar>
            </div>
